...
`);function Re(e,t){return e[t++]|e[t++]<<8|e[t++]<<16|e[t++]<<24}function ve(e,t,n){e[n++]=t,e[n++]=t>>8,e[n++]=t>>16,e[n++]=t>>24}var Y=JSON.stringify,Se="warning",ke="silent";function $e(e){if(V(e,"target"),e.indexOf(",")>=0)throw new Error(`Invalid target: ${e}`);return e}var me=()=>null,I=e=>typeof e=="boolean"?null:"a boolean",m=e=>typeof e=="string"?null:"a string",ye=e=>e instanceof RegExp?null:"a RegExp object",le=e=>typeof e=="number"&&e===(e|0)?null:"an integer",Ae=e=>typeof e=="function"?null:"a function",W=e=>Array.isArray(e)?null:"an array",ee=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",_e=e=>typeof e=="object"&&e!==null?null:"an array or an object",Ve=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Me=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",De=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",Ye=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",Je=e=>typeof e=="string"||Array.isArray(e)?null:"a string or an array",Pe=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",Qe=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function r(e,t,n,l){let u=e[n];if(t[n+""]=!0,u===void 0)return;let i=l(u);if(i!==null)throw new Error(`${Y(n)} must be ${i}`);return u}function K(e,t,n){for(let l in e)if(!(l in t))throw new Error(`Invalid option ${n}: ${Y(l)}`)}function Fe(e){let t=Object.create(null),n=r(e,t,"wasmURL",Qe),l=r(e,t,"wasmModule",Ve),u=r(e,t,"worker",I);return K(e,t,"in initialize() call"),{wasmURL:n,wasmModule:l,worker:u}}function Te(e){let t;if(e!==void 0){t=Object.create(null);for(let n in e){let l=e[n];if(typeof l=="string"||l===!1)t[n]=l;else throw new Error(`Expected ${Y(n)} in mangle cache to map to either a string or false`)}}return t}function he(e,t,n,l,u){let i=r(t,n,"color",I),d=r(t,n,"logLevel",m),o=r(t,n,"logLimit",le);i!==void 0?e.push(`--color=${i}`):l&&e.push("--color=true"),e.push(`--log-level=${d||u}`),e.push(`--log-limit=${o||0}`)}function V(e,t,n){if(typeof e!="string")throw new Error(`Expected value for ${t}${n!==void 0?" "+Y(n):""} to be a string, got ${typeof e} instead`);return e}function Be(e,t,n){let l=r(t,n,"legalComments",m),u=r(t,n,"sourceRoot",m),i=r(t,n,"sourcesContent",I),d=r(t,n,"target",Je),o=r(t,n,"format",m),y=r(t,n,"globalName",m),b=r(t,n,"mangleProps",ye),w=r(t,n,"reserveProps",ye),T=r(t,n,"mangleQuoted",I),j=r(t,n,"minify",I),U=r(t,n,"minifySyntax",I),L=r(t,n,"minifyWhitespace",I),Q=r(t,n,"minifyIdentifiers",I),B=r(t,n,"lineLimit",le),z=r(t,n,"drop",W),J=r(t,n,"dropLabels",W),v=r(t,n,"charset",m),g=r(t,n,"treeShaking",I),f=r(t,n,"ignoreAnnotations",I),s=r(t,n,"jsx",m),x=r(t,n,"jsxFactory",m),$=r(t,n,"jsxFragment",m),C=r(t,n,"jsxImportSource",m),E=r(t,n,"jsxDev",I),a=r(t,n,"jsxSideEffects",I),c=r(t,n,"define",ee),h=r(t,n,"logOverride",ee),M=r(t,n,"supported",ee),A=r(t,n,"pure",W),S=r(t,n,"keepNames",I),O=r(t,n,"platform",m),D=r(t,n,"tsconfigRaw",Ye);if(l&&e.push(`--legal-comments=${l}`),u!==void 0&&e.push(`--source-root=${u}`),i!==void 0&&e.push(`--sources-content=${i}`),d&&(Array.isArray(d)?e.push(`--target=${Array.from(d).map($e).join(",")}`):e.push(`--target=${$e(d)}`)),o&&e.push(`--format=${o}`),y&&e.push(`--global-name=${y}`),O&&e.push(`--platform=${O}`),D&&e.push(`--tsconfig-raw=${typeof D=="string"?D:JSON.stringify(D)}`),j&&e.push("--minify"),U&&e.push("--minify-syntax"),L&&e.push("--minify-whitespace"),Q&&e.push("--minify-identifiers"),B&&e.push(`--line-limit=${B}`),v&&e.push(`--charset=${v}`),g!==void 0&&e.push(`--tree-shaking=${g}`),f&&e.push("--ignore-annotations"),z)for(let R of z)e.push(`--drop:${V(R,"drop")}`);if(J&&e.push(`--drop-labels=${Array.from(J).map(R=>V(R,"dropLabels")).join(",")}`),b&&e.push(`--mangle-props=${b.source}`),w&&e.push(`--reserve-props=${w.source}`),T!==void 0&&e.push(`--mangle-quoted=${T}`),s&&e.push(`--jsx=${s}`),x&&e.push(`--jsx-factory=${x}`),$&&e.push(`--jsx-fragment=${$}`),C&&e.push(`--jsx-import-source=${C}`),E&&e.push("--jsx-dev"),a&&e.push("--jsx-side-effects"),c)for(let R in c){if(R.indexOf("=")>=0)throw new Error(`Invalid define: ${R}`);e.push(`--define:${R}=${V(c[R],"define",R)}`)}if(h)for(let R in h){if(R.indexOf("=")>=0)throw new Error(`Invalid log override: ${R}`);e.push(`--log-override:${R}=${V(h[R],"log override",R)}`)}if(M)for(let R in M){if(R.indexOf("=")>=0)throw new Error(`Invalid supported: ${R}`);let k=M[R];if(typeof k!="boolean")throw new Error(`Expected value for supported ${Y(R)} to be a boolean, got ${typeof k} instead`);e.push(`--supported:${R}=${k}`)}if(A)for(let R of A)e.push(`--pure:${V(R,"pure")}`);S&&e.push("--keep-names")}function He(e,t,n,l,u){var se;let i=[],d=[],o=Object.create(null),y=null,b=null;he(i,t,o,n,l),Be(i,t,o);let w=r(t,o,"sourcemap",De),T=r(t,o,"bundle",I),j=r(t,o,"splitting",I),U=r(t,o,"preserveSymlinks",I),L=r(t,o,"metafile",I),Q=r(t,o,"outfile",m),B=r(t,o,"outdir",m),z=r(t,o,"outbase",m),J=r(t,o,"tsconfig",m),v=r(t,o,"resolveExtensions",W),g=r(t,o,"nodePaths",W),f=r(t,o,"mainFields",W),s=r(t,o,"conditions",W),x=r(t,o,"external",W),$=r(t,o,"packages",m),C=r(t,o,"alias",ee),E=r(t,o,"loader",ee),a=r(t,o,"outExtension",ee),c=r(t,o,"publicPath",m),h=r(t,o,"entryNames",m),M=r(t,o,"chunkNames",m),A=r(t,o,"assetNames",m),S=r(t,o,"inject",W),O=r(t,o,"banner",ee),D=r(t,o,"footer",ee),R=r(t,o,"entryPoints",_e),k=r(t,o,"absWorkingDir",m),F=r(t,o,"stdin",ee),P=(se=r(t,o,"write",I))!=null?se:u,q=r(t,o,"allowOverwrite",I),_=r(t,o,"mangleCache",ee);if(o.plugins=!0,K(t,o,`in ${e}() call`),w&&i.push(`--sourcemap${w===!0?"":`=${w}`}`),T&&i.push("--bundle"),q&&i.push("--allow-overwrite"),j&&i.push("--splitting"),U&&i.push("--preserve-symlinks"),L&&i.push("--metafile"),Q&&i.push(`--outfile=${Q}`),B&&i.push(`--outdir=${B}`),z&&i.push(`--outbase=${z}`),J&&i.push(`--tsconfig=${J}`),$&&i.push(`--packages=${$}`),v){let p=[];for(let N of v){if(V(N,"resolve extension"),N.indexOf(",")>=0)throw new Error(`Invalid resolve extension: ${N}`);p.push(N)}i.push(`--resolve-extensions=${p.join(",")}`)}if(c&&i.push(`--public-path=${c}`),h&&i.push(`--entry-names=${h}`),M&&i.push(`--chunk-names=${M}`),A&&i.push(`--asset-names=${A}`),f){let p=[];for(let N of f){if(V(N,"main field"),N.indexOf(",")>=0)throw new Error(`Invalid main field: ${N}`);p.push(N)}i.push(`--main-fields=${p.join(",")}`)}if(s){let p=[];for(let N of s){if(V(N,"condition"),N.indexOf(",")>=0)throw new Error(`Invalid condition: ${N}`);p.push(N)}i.push(`--conditions=${p.join(",")}`)}if(x)for(let p of x)i.push(`--external:${V(p,"external")}`);if(C)for(let p in C){if(p.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${p}`);i.push(`--alias:${p}=${V(C[p],"alias",p)}`)}if(O)for(let p in O){if(p.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${p}`);i.push(`--banner:${p}=${V(O[p],"banner",p)}`)}if(D)for(let p in D){if(p.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${p}`);i.push(`--footer:${p}=${V(D[p],"footer",p)}`)}if(S)for(let p of S)i.push(`--inject:${V(p,"inject")}`);if(E)for(let p in E){if(p.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${p}`);i.push(`--loader:${p}=${V(E[p],"loader",p)}`)}if(a)for(let p in a){if(p.indexOf("=")>=0)throw new Error(`Invalid out extension: ${p}`);i.push(`--out-extension:${p}=${V(a[p],"out extension",p)}`)}if(R)if(Array.isArray(R))for(let p=0,N=R.length;p<N;p++){let X=R[p];if(typeof X=="object"&&X!==null){let te=Object.create(null),G=r(X,te,"in",m),ue=r(X,te,"out",m);if(K(X,te,"in entry point at index "+p),G===void 0)throw new Error('Missing property "in" for entry point at index '+p);if(ue===void 0)throw new Error('Missing property "out" for entry point at index '+p);d.push([ue,G])}else d.push(["",V(X,"entry point at index "+p)])}else for(let p in R)d.push([p,V(R[p],"entry point",p)]);if(F){let p=Object.create(null),N=r(F,p,"contents",Pe),X=r(F,p,"resolveDir",m),te=r(F,p,"sourcefile",m),G=r(F,p,"loader",m);K(F,p,'in "stdin" object'),te&&i.push(`--sourcefile=${te}`),G&&i.push(`--loader=${G}`),X&&(b=X),typeof N=="string"?y=Z(N):N instanceof Uint8Array&&(y=N)}let H=[];if(g)for(let p of g)p+="",H.push(p);return{entries:d,flags:i,write:P,stdinContents:y,stdinResolveDir:b,absWorkingDir:k,nodePaths:H,mangleCache:Te(_)}}function Ge(e,t,n,l){let u=[],i=Object.create(null);he(u,t,i,n,l),Be(u,t,i);let d=r(t,i,"sourcemap",De),o=r(t,i,"sourcefile",m),y=r(t,i,"loader",m),b=r(t,i,"banner",m),w=r(t,i,"footer",m),T=r(t,i,"mangleCache",ee);return K(t,i,`in ${e}() call`),d&&u.push(`--sourcemap=${d===!0?"external":d}`),o&&u.push(`--sourcefile=${o}`),y&&u.push(`--loader=${y}`),b&&u.push(`--banner=${b}`),w&&u.push(`--footer=${w}`),{flags:u,mangleCache:Te(T)}}function Ue(e){let t={},n={didClose:!1,reason:""},l={},u=0,i=0,d=new Uint8Array(16*1024),o=0,y=v=>{let g=o+v.length;if(g>d.length){let s=new Uint8Array(g*2);s.set(d),d=s}d.set(v,o),o+=v.length;let f=0;for(;f+4<=o;){let s=Re(d,f);if(f+4+s>o)break;f+=4,L(d.subarray(f,f+s)),f+=s}f>0&&(d.copyWithin(0,f,o),o-=f)},b=v=>{n.didClose=!0,v&&(n.reason=": "+(v.message||v));let g="The service was stopped"+n.reason;for(let f in l)l[f](g,null);l={}},w=(v,g,f)=>{if(n.didClose)return f("The service is no longer running"+n.reason,null);let s=u++;l[s]=(x,$)=>{try{f(x,$)}finally{v&&v.unref()}},v&&v.ref(),e.writeToStdin(xe({id:s,isRequest:!0,value:g}))},T=(v,g)=>{if(n.didClose)throw new Error("The service is no longer running"+n.reason);e.writeToStdin(xe({id:v,isRequest:!1,value:g}))},j=async(v,g)=>{try{if(g.command==="ping"){T(v,{});return}if(typeof g.key=="number"){let f=t[g.key];if(f){let s=f[g.command];if(s){await s(v,g);return}}}throw new Error("Invalid command: "+g.command)}catch(f){let s=[ie(f,e,null,void 0,"")];try{T(v,{errors:s})}catch(x){}}},U=!0,L=v=>{if(U){U=!1;let f=String.fromCharCode(...v);if(f!=="0.18.20")throw new Error(`Cannot start service: Host version "0.18.20" does not match binary version ${Y(f)}`);return}let g=Ee(v);if(g.isRequest)j(g.id,g.value);else{let f=l[g.id];delete l[g.id],g.value.error?f(g.value.error,{}):f(null,g.value)}};return{readFromStdout:y,afterClose:b,service:{buildOrContext:({callName:v,refs:g,options:f,isTTY:s,defaultWD:x,callback:$})=>{let C=0,E=i++,a={},c={ref(){++C===1&&g&&g.ref()},unref(){--C===0&&(delete t[E],g&&g.unref())}};t[E]=a,c.ref(),Xe(v,E,w,T,c,e,a,f,s,x,(h,M)=>{try{$(h,M)}finally{c.unref()}})},transform:({callName:v,refs:g,input:f,options:s,isTTY:x,fs:$,callback:C})=>{let E=je(),a=c=>{try{if(typeof f!="string"&&!(f instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:h,mangleCache:M}=Ge(v,s,x,ke),A={command:"transform",flags:h,inputFS:c!==null,input:c!==null?Z(c):typeof f=="string"?Z(f):f};M&&(A.mangleCache=M),w(g,A,(S,O)=>{if(S)return C(new Error(S),null);let D=oe(O.errors,E),R=oe(O.warnings,E),k=1,F=()=>{if(--k===0){let P={warnings:R,code:O.code,map:O.map,mangleCache:void 0,legalComments:void 0};"legalComments"in O&&(P.legalComments=O==null?void 0:O.legalComments),O.mangleCache&&(P.mangleCache=O==null?void 0:O.mangleCache),C(null,P)}};if(D.length>0)return C(ce("Transform failed",D,R),null);O.codeFS&&(k++,$.readFile(O.code,(P,q)=>{P!==null?C(P,null):(O.code=q,F())})),O.mapFS&&(k++,$.readFile(O.map,(P,q)=>{P!==null?C(P,null):(O.map=q,F())})),F()})}catch(h){let M=[];try{he(M,s,{},x,ke)}catch(S){}let A=ie(h,e,E,void 0,"");w(g,{command:"error",flags:M,error:A},()=>{A.detail=E.load(A.detail),C(ce("Transform failed",[A],[]),null)})}};if((typeof f=="string"||f instanceof Uint8Array)&&f.length>1024*1024){let c=a;a=()=>$.writeFile(f,c)}a(null)},formatMessages:({callName:v,refs:g,messages:f,options:s,callback:x})=>{let $=ne(f,"messages",null,"");if(!s)throw new Error(`Missing second argument in ${v}() call`);let C={},E=r(s,C,"kind",m),a=r(s,C,"color",I),c=r(s,C,"terminalWidth",le);if(K(s,C,`in ${v}() call`),E===void 0)throw new Error(`Missing "kind" in ${v}() call`);if(E!=="error"&&E!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${v}() call`);let h={command:"format-msgs",messages:$,isWarning:E==="warning"};a!==void 0&&(h.color=a),c!==void 0&&(h.terminalWidth=c),w(g,h,(M,A)=>{if(M)return x(new Error(M),null);x(null,A.messages)})},analyzeMetafile:({callName:v,refs:g,metafile:f,options:s,callback:x})=>{s===void 0&&(s={});let $={},C=r(s,$,"color",I),E=r(s,$,"verbose",I);K(s,$,`in ${v}() call`);let a={command:"analyze-metafile",metafile:f};C!==void 0&&(a.color=C),E!==void 0&&(a.verbose=E),w(g,a,(c,h)=>{if(c)return x(new Error(c),null);x(null,h.result)})}}}}function Xe(e,t,n,l,u,i,d,o,y,b,w){let T=je(),j=e==="context",U=(B,z)=>{let J=[];try{he(J,o,{},y,Se)}catch(g){}let v=ie(B,i,T,void 0,z);n(u,{command:"error",flags:J,error:v},()=>{v.detail=T.load(v.detail),w(ce(j?"Context failed":"Build failed",[v],[]),null)})},L;if(typeof o=="object"){let B=o.plugins;if(B!==void 0){if(!Array.isArray(B))return U(new Error('"plugins" must be an array'),"");L=B}}if(L&&L.length>0){if(i.isSync)return U(new Error("Cannot use plugins in synchronous API calls"),"");Ze(t,n,l,u,i,d,o,L,T).then(B=>{if(!B.ok)return U(B.error,B.pluginName);try{Q(B.requestPlugins,B.runOnEndCallbacks,B.scheduleOnDisposeCallbacks)}catch(z){U(z,"")}},B=>U(B,""));return}try{Q(null,(B,z)=>z([],[]),()=>{})}catch(B){U(B,"")}function Q(B,z,J){let v=i.hasFS,{entries:g,flags:f,write:s,stdinContents:x,stdinResolveDir:$,absWorkingDir:C,nodePaths:E,mangleCache:a}=He(e,o,y,Se,v);if(s&&!i.hasFS)throw new Error('The "write" option is unavailable in this environment');let c={command:"build",key:t,entries:g,flags:f,write:s,stdinContents:x,stdinResolveDir:$,absWorkingDir:C||b,nodePaths:E,context:j};B&&(c.plugins=B),a&&(c.mangleCache=a);let h=(S,O)=>{let D={errors:oe(S.errors,T),warnings:oe(S.warnings,T),outputFiles:void 0,metafile:void 0,mangleCache:void 0},R=D.errors.slice(),k=D.warnings.slice();S.outputFiles&&(D.outputFiles=S.outputFiles.map(et)),S.metafile&&(D.metafile=JSON.parse(S.metafile)),S.mangleCache&&(D.mangleCache=S.mangleCache),S.writeToStdout!==void 0&&console.log(re(S.writeToStdout).replace(/\n$/,"")),z(D,(F,P)=>{if(R.length>0||F.length>0){let q=ce("Build failed",R.concat(F),k.concat(P));return O(q,null,F,P)}O(null,D,F,P)})},M,A;j&&(d["on-end"]=(S,O)=>new Promise(D=>{h(O,(R,k,F,P)=>{let q={errors:F,warnings:P};A&&A(R,k),M=void 0,A=void 0,l(S,q),D()})})),n(u,c,(S,O)=>{if(S)return w(new Error(S),null);if(!j)return h(O,(k,F)=>(J(),w(k,F)));if(O.errors.length>0)return w(ce("Context failed",O.errors,O.warnings),null);let D=!1,R={rebuild:()=>(M||(M=new Promise((k,F)=>{let P;A=(_,H)=>{P||(P=()=>_?F(_):k(H))};let q=()=>{n(u,{command:"rebuild",key:t},(H,se)=>{H?F(new Error(H)):P?P():q()})};q()})),M),watch:(k={})=>new Promise((F,P)=>{if(!i.hasFS)throw new Error('Cannot use the "watch" API in this environment');K(k,{},"in watch() call"),n(u,{command:"watch",key:t},H=>{H?P(new Error(H)):F(void 0)})}),serve:(k={})=>new Promise((F,P)=>{if(!i.hasFS)throw new Error('Cannot use the "serve" API in this environment');let q={},_=r(k,q,"port",le),H=r(k,q,"host",m),se=r(k,q,"servedir",m),p=r(k,q,"keyfile",m),N=r(k,q,"certfile",m),X=r(k,q,"fallback",m),te=r(k,q,"onRequest",Ae);K(k,q,"in serve() call");let G={command:"serve",key:t,onRequest:!!te};_!==void 0&&(G.port=_),H!==void 0&&(G.host=H),se!==void 0&&(G.servedir=se),p!==void 0&&(G.keyfile=p),N!==void 0&&(G.certfile=N),X!==void 0&&(G.fallback=X),n(u,G,(ue,qe)=>{if(ue)return P(new Error(ue));te&&(d["serve-request"]=(Ne,Ie)=>{te(Ie.args),l(Ne,{})}),F(qe)})}),cancel:()=>new Promise(k=>{if(D)return k();n(u,{command:"cancel",key:t},()=>{k()})}),dispose:()=>new Promise(k=>{if(D)return k();D=!0,n(u,{command:"dispose",key:t},()=>{k(),J(),u.unref()})})};u.ref(),w(null,R)})}}var Ze=async(e,t,n,l,u,i,d,o,y)=>{let b=[],w=[],T={},j={},U=[],L=0,Q=0,B=[],z=!1;o=[...o];for(let g of o){let f={};if(typeof g!="object")throw new Error(`Plugin at index ${Q} must be an object`);let s=r(g,f,"name",m);if(typeof s!="string"||s==="")throw new Error(`Plugin at index ${Q} is missing a name`);try{let x=r(g,f,"setup",Ae);if(typeof x!="function")throw new Error("Plugin is missing a setup function");K(g,f,`on plugin ${Y(s)}`);let $={name:s,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};Q++;let E=x({initialOptions:d,resolve:(a,c={})=>{if(!z)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof a!="string")throw new Error("The path to resolve must be a string");let h=Object.create(null),M=r(c,h,"pluginName",m),A=r(c,h,"importer",m),S=r(c,h,"namespace",m),O=r(c,h,"resolveDir",m),D=r(c,h,"kind",m),R=r(c,h,"pluginData",me);return K(c,h,"in resolve() call"),new Promise((k,F)=>{let P={command:"resolve",path:a,key:e,pluginName:s};if(M!=null&&(P.pluginName=M),A!=null&&(P.importer=A),S!=null&&(P.namespace=S),O!=null&&(P.resolveDir=O),D!=null)P.kind=D;else throw new Error('Must specify "kind" when calling "resolve"');R!=null&&(P.pluginData=y.store(R)),t(l,P,(q,_)=>{q!==null?F(new Error(q)):k({errors:oe(_.errors,y),warnings:oe(_.warnings,y),path:_.path,external:_.external,sideEffects:_.sideEffects,namespace:_.namespace,suffix:_.suffix,pluginData:y.load(_.pluginData)})})})},onStart(a){let c='This error came from the "onStart" callback registered here:',h=pe(new Error(c),u,"onStart");b.push({name:s,callback:a,note:h}),$.onStart=!0},onEnd(a){let c='This error came from the "onEnd" callback registered here:',h=pe(new Error(c),u,"onEnd");w.push({name:s,callback:a,note:h}),$.onEnd=!0},onResolve(a,c){let h='This error came from the "onResolve" callback registered here:',M=pe(new Error(h),u,"onResolve"),A={},S=r(a,A,"filter",ye),O=r(a,A,"namespace",m);if(K(a,A,`in onResolve() call for plugin ${Y(s)}`),S==null)throw new Error("onResolve() call is missing a filter");let D=L++;T[D]={name:s,callback:c,note:M},$.onResolve.push({id:D,filter:S.source,namespace:O||""})},onLoad(a,c){let h='This error came from the "onLoad" callback registered here:',M=pe(new Error(h),u,"onLoad"),A={},S=r(a,A,"filter",ye),O=r(a,A,"namespace",m);if(K(a,A,`in onLoad() call for plugin ${Y(s)}`),S==null)throw new Error("onLoad() call is missing a filter");let D=L++;j[D]={name:s,callback:c,note:M},$.onLoad.push({id:D,filter:S.source,namespace:O||""})},onDispose(a){U.push(a)},esbuild:u.esbuild});E&&await E,B.push($)}catch(x){return{ok:!1,error:x,pluginName:s}}}i["on-start"]=async(g,f)=>{let s={errors:[],warnings:[]};await Promise.all(b.map(async({name:x,callback:$,note:C})=>{try{let E=await $();if(E!=null){if(typeof E!="object")throw new Error(`Expected onStart() callback in plugin ${Y(x)} to return an object`);let a={},c=r(E,a,"errors",W),h=r(E,a,"warnings",W);K(E,a,`from onStart() callback in plugin ${Y(x)}`),c!=null&&s.errors.push(...ne(c,"errors",y,x)),h!=null&&s.warnings.push(...ne(h,"warnings",y,x))}}catch(E){s.errors.push(ie(E,u,y,C&&C(),x))}})),n(g,s)},i["on-resolve"]=async(g,f)=>{let s={},x="",$,C;for(let E of f.ids)try{({name:x,callback:$,note:C}=T[E]);let a=await $({path:f.path,importer:f.importer,namespace:f.namespace,resolveDir:f.resolveDir,kind:f.kind,pluginData:y.load(f.pluginData)});if(a!=null){if(typeof a!="object")throw new Error(`Expected onResolve() callback in plugin ${Y(x)} to return an object`);let c={},h=r(a,c,"pluginName",m),M=r(a,c,"path",m),A=r(a,c,"namespace",m),S=r(a,c,"suffix",m),O=r(a,c,"external",I),D=r(a,c,"sideEffects",I),R=r(a,c,"pluginData",me),k=r(a,c,"errors",W),F=r(a,c,"warnings",W),P=r(a,c,"watchFiles",W),q=r(a,c,"watchDirs",W);K(a,c,`from onResolve() callback in plugin ${Y(x)}`),s.id=E,h!=null&&(s.pluginName=h),M!=null&&(s.path=M),A!=null&&(s.namespace=A),S!=null&&(s.suffix=S),O!=null&&(s.external=O),D!=null&&(s.sideEffects=D),R!=null&&(s.pluginData=y.store(R)),k!=null&&(s.errors=ne(k,"errors",y,x)),F!=null&&(s.warnings=ne(F,"warnings",y,x)),P!=null&&(s.watchFiles=ge(P,"watchFiles")),q!=null&&(s.watchDirs=ge(q,"watchDirs"));break}}catch(a){s={id:E,errors:[ie(a,u,y,C&&C(),x)]};break}n(g,s)},i["on-load"]=async(g,f)=>{let s={},x="",$,C;for(let E of f.ids)try{({name:x,callback:$,note:C}=j[E]);let a=await $({path:f.path,namespace:f.namespace,suffix:f.suffix,pluginData:y.load(f.pluginData)});if(a!=null){if(typeof a!="object")throw new Error(`Expected onLoad() callback in plugin ${Y(x)} to return an object`);let c={},h=r(a,c,"pluginName",m),M=r(a,c,"contents",Pe),A=r(a,c,"resolveDir",m),S=r(a,c,"pluginData",me),O=r(a,c,"loader",m),D=r(a,c,"errors",W),R=r(a,c,"warnings",W),k=r(a,c,"watchFiles",W),F=r(a,c,"watchDirs",W);K(a,c,`from onLoad() callback in plugin ${Y(x)}`),s.id=E,h!=null&&(s.pluginName=h),M instanceof Uint8Array?s.contents=M:M!=null&&(s.contents=Z(M)),A!=null&&(s.resolveDir=A),S!=null&&(s.pluginData=y.store(S)),O!=null&&(s.loader=O),D!=null&&(s.errors=ne(D,"errors",y,x)),R!=null&&(s.warnings=ne(R,"warnings",y,x)),k!=null&&(s.watchFiles=ge(k,"watchFiles")),F!=null&&(s.watchDirs=ge(F,"watchDirs"));break}}catch(a){s={id:E,errors:[ie(a,u,y,C&&C(),x)]};break}n(g,s)};let J=(g,f)=>f([],[]);w.length>0&&(J=(g,f)=>{(async()=>{let s=[],x=[];for(let{name:$,callback:C,note:E}of w){let a,c;try{let h=await C(g);if(h!=null){if(typeof h!="object")throw new Error(`Expected onEnd() callback in plugin ${Y($)} to return an object`);let M={},A=r(h,M,"errors",W),S=r(h,M,"warnings",W);K(h,M,`from onEnd() callback in plugin ${Y($)}`),A!=null&&(a=ne(A,"errors",y,$)),S!=null&&(c=ne(S,"warnings",y,$))}}catch(h){a=[ie(h,u,y,E&&E(),$)]}if(a){s.push(...a);try{g.errors.push(...a)}catch(h){}}if(c){x.push(...c);try{g.warnings.push(...c)}catch(h){}}}f(s,x)})()});let v=()=>{for(let g of U)setTimeout(()=>g(),0)};return z=!0,{ok:!0,requestPlugins:B,runOnEndCallbacks:J,scheduleOnDisposeCallbacks:v}};function je(){let e=new Map,t=0;return{load(n){return e.get(n)},store(n){if(n===void 0)return-1;let l=t++;return e.set(l,n),l}}}function pe(e,t,n){let l,u=!1;return()=>{if(u)return l;u=!0;try{let i=(e.stack+"").split(`
